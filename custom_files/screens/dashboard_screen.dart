...
class DashboardScreen extends StatelessWidget {
  ...
  // STATS HEADER
  Widget _buildStatsHeader(BuildContext context, UserProfile profile) {
    return Row(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: const AssetImage('assets/images/stars_bg.png'), // will show if present, otherwise fails gracefully
          fit: BoxFit.cover,
